...
const AIGuideDemo: React.FC<{ onComplete?: () => void; timeline?: any }> = ({ onComplete, timeline: propTimeline }) => {
  ...
  // 使用 DemoController 传过来的 timeline
  const timeline = propTimeline || { workbenchStay: 2000, intro: 2000, userSpeech: 12000, thinking: 25000, feedback: 30000, report: 42000, complete: 52000 };
