...
// FIXED: Responsive Tablet Wrapper
...
const PrivateDomainDemo: React.FC<{ onComplete?: () => void; timeline?: any }> = ({ onComplete, timeline: propTimeline }) => {
  ...
  const timeline = propTimeline || { userMsg: 1000, aiHint: 2500, typing: 4500, agentMsg: 6000, cardMsg: 7500, commission: 10500, userReply: 13000, finish: 16000 };
