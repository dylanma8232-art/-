...
export const DEMO_PLAYLIST: SceneConfig[] = [
  ...
  { 
    ...
    timeline: {
      ...
      card: 6000,     // 6秒后：发送第三条消息 (排程卡片) - 这里延后一点确保阅读
      openMap: 10000, // 10秒后：模拟点击卡片，跳转到地图界面
      finish: 22000   // 22秒：本模块逻辑结束
    }
  },
  ...
  { 
    ...
    timeline: {
      workbenchStay: 4000, // 4秒：“今日必修任务”页面停留时间，之后进入对话
      intro: 2000,         // 进入对话 2秒后：AI 教练开始说开场白
      userSpeech: 4000,    // 8秒后：用户开始回答 (模拟录音)
      thinking: 7000,     // 14秒后：AI 开始思考分析
      feedback: 10000,     // 18秒后：AI 给出语音点评
      report: 13000,       // 24秒后：切换到“培训诊断报告”页面
      complete: 18000      // 35秒：本模块逻辑结束
    }
  },
