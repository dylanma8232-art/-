                ...
                <AnimatePresence>
                    {aiPlanVisible && (
                        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex-1 flex flex-col space-y-4">
                            {/* FIXED: Removed preserveAspectRatio to fix distortion */}
                            ...
                            {/* FIXED: Increased spacing (space-y-4) and padding for better layout */}
                            <div className="space-y-4">
                                <div className="bg-white rounded-xl p-3 border-l-4 border-orange-500 shadow-sm flex items-start space-x-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-center mb-1"><span className="font-bold text-lg text-slate-800">罗森 (丹棱街)</span><span className="text-[10px] text-orange-500 bg-orange-50 px-2 py-1 rounded-full font-bold">库存预警</span></div>
                                        <div className="text-sm text-slate-500">任务: 盘点冷柜饮料库存</div>
                                    </div>
                                </div>
                                <div className="bg-white rounded-xl p-3 border-l-4 border-blue-500 shadow-sm flex items-start space-x-4 opacity-70">
                                    ...
                                    <div className="flex-1"><div className="flex justify-between items-center mb-1"><span className="font-bold text-lg text-slate-800">7-Eleven (海淀黄庄)</span></div><div className="text-sm text-slate-500">任务: 新品陈列检查</div></div>
                                </div>
                            </div>
