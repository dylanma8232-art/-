...
import ClairvoyanceDemo from '../components/demos/ClairvoyanceDemo';
...
export const DEMO_PLAYLIST: SceneConfig[] = [
  ...
  { 
    ...
    timeline: {
      ...
      userSpeech: 3500,    // 5.5秒后：轮到用户回答 (模拟录音 耗时约6s)
      thinking: 6000,     // 12秒后：AI 开始思考分析 (耗时1.5s)
      feedback: 7000,     // 13.5秒后：AI 给出语音点评 (耗时约7s)
      report: 9500,       // 20.5秒后：切换到“培训诊断报告”页面
      complete: 15000
    }
  },
  ...
  {
    id: 'smart_vision',
    title: '7. 千里眼 (Smart Vision)',
    component: ClairvoyanceDemo,
    duration: 18000,
    intro: {
        title: "千里眼 (Smart Vision)",
        role: "智能终端",
        goal: "实时视觉捕捉与销售机会转化",
        duration: 1000
    },
